...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2025 a las 05:16:51
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insertar_producto_desde_proveedor` (IN `p_id_producto_proveedor` INT, IN `p_cantidad_comprada` INT)   BEGIN
    ...
    -- Se obtienen todos los datos necesarios, incluyendo unidad_medida y es_perecedero
    SELECT 
    ...
    IF v_existe_producto > 0 THEN
        -- Actualizar producto existente (solo cantidad y precios)
        UPDATE productos
    ...
    ELSE
        -- Insertar producto nuevo, incluyendo unidad_medida y es_perecedero
        INSERT INTO productos (
            codigo, nombre, descripcion, categoria_id, proveedor_id,
            id_producto_proveedor, precio_costo, precio_venta,
            fecha_vencimiento, unidad_medida, es_perecedero, cantidad, created_at, updated_at
        ) VALUES (
            ...
            NULL, v_unidad_medida, v_es_perecedero, p_cantidad_comprada, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
        );
    END IF;
...
(13, 'alcohol', 'active', '2025-12-02 01:03:45');
...
(34, 9, 5, 6, '2025-12-04', '2026-01-03', 5, '2025-12-04 04:16:32'),
(35, 11, 3, 5, '2025-12-04', '2026-01-03', 5, '2025-12-04 04:16:32'),
(36, 5, 10, 6, '2025-12-04', '2026-01-03', 5, '2025-12-04 04:16:32');
...
(13, 34, 9, 5, 6, 30, 50.00, '2025-12-04', '2026-01-03', 5, '2025-12-04 04:16:32'),
(14, 35, 11, 3, 5, 15, 54.00, '2025-12-04', '2026-01-03', 5, '2025-12-04 04:16:32'),
(15, 36, 5, 10, 6, 60, 80.00, '2025-12-04', '2026-01-03', 5, '2025-12-04 04:16:32');
...
INSERT INTO `productos` (`id`, `codigo`, `nombre`, `categoria_id`, `subcategoria_id`, `proveedor_id`, `id_producto_proveedor`, `fecha_vencimiento`, `unidad_medida`, `es_perecedero`, `cantidad`, `precio_costo`, `precio_venta`, `created_at`, `updated_at`, `estado`) VALUES
(15, 'PROD-009', 'Choclate con Leche', 6, NULL, 3, 9, '2026-01-03', 'unidad', 0, 230, 1.67, 2.17, '2025-12-04 03:48:16', '2025-12-04 04:16:32', 'active'),
(16, 'PROD-011', 'Cocosette', 6, NULL, 3, 11, '2026-01-03', 'unidad', 0, 215, 3.60, 4.68, '2025-12-04 03:48:16', '2025-12-04 04:16:32', 'active'),
(17, 'PROD-001', 'Crema de Leche', 1, 1, 1, 5, '2026-01-03', 'litro', 1, 60, 1.33, 1.73, '2025-12-04 04:16:32', '2025-12-04 04:16:32', 'active');
...
(5, 'PROD-001', 'Crema de Leche', 1, 1, 1, 1.33, 'litro', '2025-12-04', 1, '2025-10-29 21:55:16', '2025-12-04 04:16:32'),
...
(9, 'PROD-009', 'Choclate con Leche', 6, NULL, 3, 1.67, 'unidad', '2025-12-04', 1, '2025-11-12 20:27:03', '2025-12-04 04:16:32'),
(10, 'PROD-010', 'Samba', 6, NULL, 3, 1.67, 'unidad', '2025-11-14', 1, '2025-11-12 21:36:37', '2025-11-14 12:25:25'),
(11, 'PROD-011', 'Cocosette', 6, NULL, 3, 3.60, 'unidad', '2025-12-04', 1, '2025-11-12 21:37:50', '2025-12-04 04:16:32');
