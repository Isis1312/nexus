...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2025 a las 23:58:38
...
INSERT INTO `detalle_venta` (`id_detalle`, `id_venta`, `id_producto`, `codigo_producto`, `nombre_producto`, `cantidad`, `precio_unitario_bs`, `precio_unitario_usd`, `precio_unitario_eur`, `subtotal_bs`, `subtotal_usd`, `subtotal_eur`) VALUES
(1, 3, 7, NULL, NULL, 5.00, 2.29, 0.23, 0.20, 11.45, 1.15, 1.00),
(2, 3, 8, NULL, NULL, 2.00, 6.25, 0.63, 0.55, 12.50, 1.26, 1.10);
...
(7, 'PROD-009', 'Choclate con Leche', 6, NULL, 3, 9, '2025-12-12', 45, 2.29, NULL, '2025-11-12 20:51:20', '2025-11-12 20:53:33', 'active'),
(8, 'PROD-008', 'Queso', 1, 2, 2, 8, '2025-12-12', 24, 6.25, NULL, '2025-11-12 20:55:30', '2025-11-27 09:38:15', 'active'),
(9, 'PROD-011', 'Cocosette', 6, NULL, 3, 11, '2026-03-04', 24, 10.00, NULL, '2025-11-12 21:38:24', '2025-11-14 11:39:49', 'active');
...
INSERT INTO `ventas` (`id_venta`, `cliente`, `fecha`, `metodo_pago`, `total_bs`, `estado`, `id_cliente`, `total_usd`, `total_eur`, `tasa_usd`, `tasa_eur`, `nro_factura`) VALUES
(1, 'Isis Sofia', '2025-12-01', 'Efectivo', 250.00, 'Pagado', 1, 25.00, 22.00, 10.0000, 11.3636, 'FAC-0001'),
(3, 'Isis Sofia', '2025-12-01', 'Efectivo', 250.00, 'Pagado', 1, 25.00, 22.00, 10.0000, 11.3636, 'FAC-0001');
